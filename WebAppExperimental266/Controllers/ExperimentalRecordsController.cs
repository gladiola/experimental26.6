...
namespace WebAppExperimental266.Controllers
{
    ...
    public class ExperimentalRecordsController : Controller
    {
        ...
        private readonly ILogger<ExperimentalRecordsController> _logger;
        private readonly GroupAccessSettings _groupAccessSettings;

        public ExperimentalRecordsController(
            CrudDbContext dbContext,
            IAuthorizationService authorizationService,
            ILogger<ExperimentalRecordsController> logger,
        ...
        {
            LoggingHelper.TrackFunctionCall(HttpContext, "ExperimentalRecordsController.Index");
        ...
        {
            LoggingHelper.TrackFunctionCall(HttpContext, "ExperimentalRecordsController.Details");
        ...
        {
            LoggingHelper.TrackFunctionCall(HttpContext, "ExperimentalRecordsController.Create");
        ...
        {
            LoggingHelper.TrackFunctionCall(HttpContext, "ExperimentalRecordsController.Download");
            CrudRecord? record;
        ...
        {
            LoggingHelper.TrackFunctionCall(HttpContext, "ExperimentalRecordsController.Edit");
        ...
        {
            LoggingHelper.TrackFunctionCall(HttpContext, "ExperimentalRecordsController.EditPost");
            if (id != input.Id)
            {
                return NotFound();
            }
        ...
        {
            LoggingHelper.TrackFunctionCall(HttpContext, "ExperimentalRecordsController.Delete");
        ...
        {
            LoggingHelper.TrackFunctionCall(HttpContext, "ExperimentalRecordsController.DeleteConfirmed");
